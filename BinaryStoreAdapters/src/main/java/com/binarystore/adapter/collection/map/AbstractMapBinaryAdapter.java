...
public abstract class AbstractMapBinaryAdapter<T extends Map> extends BaseBinaryAdapter<T> {
    ...
    public int getSize(T value) throws Exception {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public void serialize(ByteBuffer byteBuffer, T value) throws Exception {
        int index = 0;
        final Adapters adapters = new Adapters();
    ...
    @Override
    @SuppressWarnings("unchecked")
    public T deserialize(ByteBuffer byteBuffer) throws Exception {
        final Adapters adapters = new Adapters();
